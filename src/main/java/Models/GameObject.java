...
public class GameObject {
  ...
  public GameObject(UUID id, Integer size, Integer speed, Integer currentHeading, Position position, ObjectTypes gameObjectType, Integer effects, Integer torpedoCount, Integer supernovaAvailable, Integer teleCount, Integer shieldCount) {
    this.id = id;
    this.size = size;
    this.speed = speed;
